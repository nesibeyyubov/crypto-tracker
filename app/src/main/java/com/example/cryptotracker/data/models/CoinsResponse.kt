    ...
    this.mapKeys {
        ...
        coins.add(
            Coin(
                ...
                type = coinType,
                usd = it.value[USD].orEmptyString(),
                usdMarketCap = it.value[USD_MARKET_CAP].orEmptyString(),
                usd24hChange = it.value[USD_24H_CHANGE].orEmptyString(),
...
enum class CoinType(@DrawableRes val drawable: Int) {
    Bitcoin(R.drawable.ic_bitcoin), Ethereum(R.drawable.ic_ethereum), Ripple(R.drawable.ic_ripple)
}
